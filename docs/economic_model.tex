...
The current real-rate gap is ex ante: the central bank knows expected inflation
when it chooses $i_t$.  Historical gaps use realized inflation because their
outcomes are already observed.  A real rate above $\rstar$ reduces
